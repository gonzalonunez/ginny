...
An even more compelling option would be adding a community-supported Swift runtime to [Vercel](https://github.com/vercel/vercel/blob/main/DEVELOPING_A_RUNTIME.md).
